...
<head>
  ...
  <title>Personal To Do - Sprinklist</title>
...
<body>
  ...
  <div class="sidebar">
    ...
    <div class="submenu active-menu" id="todo-submenu">
      <a href="todo/personal.php" style="background-color: #f8d7d7; color: #7a4e2f;"><i class="fa-solid fa-user"></i> Personal</a>
  ...
  <script>
    ...
    function confirmDelete(id) {
      if (confirm('Apakah Anda yakin ingin menghapus to-do ini?')) {
        window.location.href = 'todo/personal.php?delete=' + id;
      }
    }
  </script>
